...
public class ForeRESTController {
    ...
    public Object changeOderItem(HttpSession session,int pid,int num){
        User user = (User) session.getAttribute("user");
        if(null == user){
            return Result.fail("未登录");
        }
    ...
    public Object bought(HttpSession session){
        ...
        if(null == user)
            return Result.fail("未登录");
        List<Order> os = orderService.listByUserWithoutDeleted(user);
