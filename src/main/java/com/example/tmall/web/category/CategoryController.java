package com.example.tmall.web.category;
...
public class CategoryController {
    ...
    public Page4Navigator<Category> list(@RequestParam(value = "start",defaultValue = "0") int start,@RequestParam(value = "size",defaultValue =
            "5") int size) throws
            Exception{
